...
const shapeInfoModule = {
  ...
  actions: {
    ...
    /**
     * Add a shape information predicate with the given values to the given shape.
     * @param state
     * @param getters
     * @param commit
     * @param dispatch
...
export { shapeInfoModule as default };
